...
public class user1 extends AppCompatActivity implements View.OnClickListener{
        ...
        sRef.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        com.example.keshav.qp.Upload upload = new com.example.keshav.qp.Upload(editTextFilename.getText().toString(), taskSnapshot.getDownloadUrl().toString());
